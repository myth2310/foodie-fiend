          ...
          <div class="pb-2">
            <form id="dataFormCategory" action="<?php echo "/data/category/update/" . $data->id ?>" class="mb-8 w-auto px-6 mr-2" method="post">
              <div class="mb-5">
                ...
                <input type="text" name="name" id="name" value="<?= $data->name ?>" placeholder="Nama kategori" class="shadow-sm border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required/>
              </div>
              <div class="mb-5">
                <label for="description" class="block mb-2 text-sm font-medium text-gray-900">Kategori</label>
                <input type="text" name="description" id="description" value="<?= $data->description ?>" placeholder="Deskripsi kategori" class="shadow-sm border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required/>
              </div>
              <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-2">
                <button type="submit" class="ml-0 text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Perbarui Kategori</button>

      ...
      <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-800 dark:shadow-dark-xl rounded-2xl bg-clip-border">
        ...
        <div class="flex-auto px-0 pt-0 pb-2">
          <div id="menuContent" class="p-0 overflow-x-auto">
            ...
            <table id="tableMenu" class="items-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                  ...
                  <?php foreach($menus as $menu): ?>
                    <tr>
                      ...
                      <td class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent space-x-4 items-center">
                        <a href="<?php echo '/dashboard/menu/edit/' . $menu->id ?>" class="font-semibold leading-tight dark:text-white dark:opacity-80 text-white bg-blue-600 px-3.5 py-1.5 rounded-md"> Edit </a>

  ...
  <hr class="h-px mt-0 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent" />
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto grow basis-full">
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-1.5 w-full">
          <a class="py-1.5 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 rounded-lg hover:font-semibold hover:bg-blue-500/13 hover:text-slate-700 transition-colors" href="<?= base_url('dashboard/menu') ?>">
            <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
        ...
        <li class="mt-1.5 w-full">
          <a class="py-1.5 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 rounded-lg hover:font-semibold hover:bg-blue-500/13 hover:text-slate-700 transition-colors" href="<?= base_url('dashboard/order') ?>">

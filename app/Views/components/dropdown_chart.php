<!-- Dropdown menu -->
<div id="dropdownChart" class="hidden right-10 mt-10 origin-top-right z-20 w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow" aria-labelledby="dropdownNotificationButton">
          ...
          <li>
            <a href="<?php echo '/' ?>" class="flex px-4 py-3 hover:bg-gray-10">
              <div class="flex-shrink-0">
                <img class="w-15 h-11" src="<?= $chart->menu_img ?>" alt="Menu Image">
              </div>

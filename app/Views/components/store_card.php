<?php $stores = $items['stores']; ?>
<div id="menuCard" class="container mx-auto px-4 py-6 z-0">
  <div class="flex py-4">
    <h2 class="text-2xl font-semibold text-gray-800">Kumpulan Kuliner UMKM</h2>
  </div>
      ...
      <?php foreach($stores as $store): ?>
        <div class="relative mb-2 flex w-full max-w-xs flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-md">
          ...
          <div class="mt-4 px-5 pb-5 space-y-3">
            <p></p>
            <h5 class="text-lg font-semibold tracking-tight text-slate-900 text-center capitalize"><?= $store->name ?? "" ?></h5>

    ...
    <?php if(!empty($stores)):?>
      ...
      <div class="relative mb-2 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
        ...
        <div class="mt-4 px-5 pb-5">
          <a href="<?= base_url('stores/' . $store->id) ?>">
          ...
          <div class="mt-2 mb-5 flex items-center justify-between">
            <div class="flex items-center mb-2">
              ...
              <span class="mr-2 ml-3 rounded bg-yellow-200 px-2.5 py-0.5 text-xs font-semibold"><?= $store->rating ?? "0" ?></span>
            </div>
          </div>
          <?php if($use_chart_button): ?>

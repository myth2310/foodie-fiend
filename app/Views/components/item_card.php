...
<div id="menuCard" class="container mx-auto py-6 z-0">
  <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
    <div class="relative mb-2 flex w-full max-w-xs flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-md">
      <a href="<?= base_url('stores/') ?>" class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl">
        <img class="object-cover" src="https://cdn.idntimes.com/content-images/community/2022/06/tips-membuat-kuah-bakso-enak-gurih-kaldu-mantap-tips-kuah-bakso-enak-cara-membuat-kuah-bakso-enak-cara-membuat-kuah-bakso-lezat-resep-kuah-bakso-bahan-kuah-bakso-9cde86371d7fc78c91ae80a6ffab250e-e7d5ef4a29a66c036362b3685ee985f6_600x400.jpg" alt="product image" />
      ...
      <div class="mt-4 px-5 pb-5">
        ...
        <div class="mt-2 mb-5 flex items-center justify-between">
          <p>
            <span class="text-md font-bold text-slate-900">Rp.</span>
          </p>

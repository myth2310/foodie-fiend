<nav class="bg-white shadow-md border-gray-200 dark:bg-gray-900">
  ...
  <div class="flex md:order-2">
    ...
    <?php if(session()->get('email')): ?>
      <div class="ml-4">
        <a href="/dashboard" class="cursor-pointer focus:outline">
          <img src="<?= session()->get('profile') ?>" alt="profil" class="rounded-xl w-10 h-10">
        </a>
      </div>
    <?php else: ?>
      <button onclick="openModal('loginModal')" type="button" class="text-white bg-yellow-500 hover:bg-yellow-600 ml-4 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-semibold rounded-lg text-sm px-4 py-2 text-center">Mulai Sekarang</button>
    <?php endif ?>
  </div>

<nav class="bg-white shadow-md border-gray-200 fixed top-0 left-0 w-full z-50">
  ...
  <div class="flex md:order-2">
    ...
    <!-- <div class="relative hidden md:block">
      ...
      <input type="text" id="search-navbar" class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-yellow-300 focus:border-yellow-400" placeholder="Cari...">
    </div> -->

    <?php if(session()->get('role') != 'store'): ?>
    <button onclick="onChartClick()" class="flex pl-2 transition duration-150 ease-in-out focus:ring-4 focus:outline-none focus:ring-yellow-300 focus:bg-yellow-500 focus:text-white hover:bg-yellow-500 hover:text-white text-black items-center justify-between ml-4 rounded-xl">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
      <div class="relative mt-3 md:hidden">
        ...
        <input type="text" id="search-navbar" class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari...">
      </div>
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border items-center border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
        <li>
          <a href="/" id="homeMenuBtn" class="block py-2 px-3 text-yellow-500 text-lg md:text-lg hover:text-yellow-500 transition-all ease-in-out duration-150 rounded md:bg-transparent md:p-0 font-semibold focus:ring-4 focus:outline-none focus:ring-yellow-300 focus:text-yellow-500" aria-current="page">Beranda</a>
        </li>
        <li>
